...
import com.coremedia.labs.plugins.adapters.googledrive.model.GoogleDriveFolder;
import com.coremedia.labs.plugins.adapters.googledrive.model.FileAdapter;
import com.coremedia.labs.plugins.adapters.googledrive.model.GoogleDriveItem;
...
public class GoogleDriveContentHubAdapter implements ContentHubAdapter, ContentHubSearchService {
  ...
  public Collection<ContentHubType> supportedTypes() {
    return List.of(
            new ContentHubType(GoogleDriveService.GENERIC_FILE_TYPE),
            new ContentHubType(GoogleDriveService.IMAGES_TYPE),
            new ContentHubType(GoogleDriveService.VIDEO_TYPE)
    );
  }
